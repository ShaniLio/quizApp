...
export default function App() {
  // ============ CONFIGURATION ============
  const QUESTIONS_PER_QUIZ = 100; // Change this number to set how many questions per quiz
  ...
  useEffect(() => {
    // If you want to auto-start, uncomment the line below
    // startNewQuiz();
  }, []);
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-50 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-8 text-center">
          <div className="mb-6">
            <div className="w-20 h-20 mx-auto bg-gradient-to-r from-indigo-500 to-purple-500 rounded-2xl flex items-center justify-center mb-4">
          ...
          <div className="bg-gray-50 rounded-xl p-4 mb-6 text-left">
            <div className="flex justify-between items-center py-2 border-b border-gray-200">
              <span className="text-gray-600">Total Questions Available</span>
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl"
          >
          ...
          <p className="text-xs text-gray-400 mt-4">
            {QUESTIONS_PER_QUIZ} random questions will be selected from {totalAvailableQuestions} available
          </p>
        </div>
      </div>
    );
        ...
        <div className="bg-white rounded-2xl shadow-xl max-w-2xl w-full p-8">
          ...
          <div className="text-center">
            ...
            <div className="text-left mb-6 max-h-64 overflow-y-auto">
              ...
              {questions.map((q, i) => (
                <div key={i} className="flex items-start gap-2 mb-2 p-2 rounded-lg bg-gray-50">
                  {answers[i]?.correct ? (
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button
                onClick={goHome}
                className="flex-1 bg-gray-200 hover:bg-gray-300 text-gray-700 font-semibold py-3 px-6 rounded-xl flex items-center justify-center gap-2 transition-colors"
              >
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 to-purple-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl max-w-2xl w-full p-8">
        ...
        <div className="mb-4">
          <h1 className="text-xl font-bold text-gray-800">{quizData.title || "Quiz"}</h1>
          {quizData.description && (
            <p className="text-gray-500 text-xs mt-1">{quizData.description}</p>
          )}
        </div>
